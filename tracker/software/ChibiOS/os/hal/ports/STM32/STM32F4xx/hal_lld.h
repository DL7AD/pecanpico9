...
#define STM32_I2CFMP1SEL_PCLK1  (0 << 22)   /**< I2C1 source is PCLK1.      */
...
#if defined(STM32F413xx)
/* TODO: Chibios definition could be set from CMSIS stm32f413xx.h.          */
#define STM32_LPTIM1SEL_MASK    (3 << 30)   /**< LPTIM1SEL mask.            */
#define STM32_LPTIM1SEL_PCLK1   (0 << 22)   /**< LPTIM1 source is PCLK1.    */
#define STM32_LPTIM1SEL_SYSCLK  (1 << 22)   /**< LPTIM1 source is SYSCLK.   */
#define STM32_LPTIM1SEL_HSI     (2 << 22)   /**< LPTIM1 source is HSI.      */
#endif
/** @} */
